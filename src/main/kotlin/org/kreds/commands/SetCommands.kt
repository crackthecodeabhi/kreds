...
interface BaseSetCommands {
    ...
    fun _sadd(key: String, member: String, vararg members: String)=
     ...
     fun _sdiff(key: String, vararg keys: String) = CommandExecution(SDIFF, ArrayCommandProcessor,*createArguments(
         key, *keys
     ))


     fun _sdiffstore(destination: String, key: String, vararg keys: String)=
         CommandExecution(SDIFFSTORE, ArrayCommandProcessor,*createArguments(destination,key,*keys))
    ...
    fun _smove(source: String, destination: String, member: String) =
        CommandExecution(SMOVE, IntegerCommandProcessor,source.toArgument(),destination.toArgument(),member.toArgument())
    ...
    fun _srem(key: String, member: String,vararg members: String) =
        CommandExecution(SREM, IntegerCommandProcessor,*createArguments(
            key,member,*members
        ))
